...
Note: The original function does not handle exceptions for invalid inputs like `k > n` or negative values. If you want to handle these cases, you should modify the function to raise `ValueError` for such inputs.
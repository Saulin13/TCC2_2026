...
def test_segments_intersect_vertical_no_intersection():
...
def test_segments_intersect_no_intersection_far_apart():
    assert segments_intersect(Point(0, 0), Point(1, 1), Point(3, 3), Point(4, 4)) is False

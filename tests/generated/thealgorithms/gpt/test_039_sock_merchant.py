...
def test_sock_merchant_all_pairs():
    assert sock_merchant([1, 1, 2, 2, 3, 3, 4, 4]) == 4
    assert sock_merchant([7, 7, 7, 7]) == 2

def test_sock_merchant_single_color():
    assert sock_merchant([9, 9, 9, 9, 9]) == 2
    assert sock_merchant([8, 8, 8, 8, 8, 8]) == 3

def test_sock_merchant_large_numbers():
    assert sock_merchant([1000000, 1000000, 1000000, 1000000]) == 2
    assert sock_merchant([999999, 999999, 999999]) == 1

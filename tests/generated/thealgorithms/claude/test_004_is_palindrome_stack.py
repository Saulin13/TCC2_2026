...
def test_is_palindrome_stack_negative_values():
    head = ListNode(-1, ListNode(0, ListNode(-1)))
    assert is_palindrome_stack(head) is True


def test_is_palindrome_stack_negative_values_not_palindrome():
    head = ListNode(-1, ListNode(0, ListNode(1)))
    assert is_palindrome_stack(head) is False


def test_is_palindrome_stack_same_values():
    head = ListNode(5, ListNode(5, ListNode(5, ListNode(5))))
    assert is_palindrome_stack(head) is True


def test_is_palindrome_stack_zero_values():
    head = ListNode(0, ListNode(0))
    assert is_palindrome_stack(head) is True


def test_is_palindrome_stack_large_palindrome():
    head = ListNode(1, ListNode(2, ListNode(3, ListNode(4, ListNode(5, ListNode(4, ListNode(3, ListNode(2, ListNode(1)))))))))
    assert is_palindrome_stack(head) is True


def test_is_palindrome_stack_large_not_palindrome():

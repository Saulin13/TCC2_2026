...
def test_calculate_probabilities_half():
    result = calculate_probabilities(50, 100)
    assert result == pytest.approx(0.5)


def test_calculate_probabilities_zero_total_raises_exception():
...
def test_calculate_probabilities_float_inputs():
    result = calculate_probabilities(15.5, 50.0)

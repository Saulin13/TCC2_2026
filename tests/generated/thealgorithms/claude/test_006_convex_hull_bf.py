...
def test_convex_hull_bf_unsorted_input():
    points = [[5, 5], [0, 0], [3, 3], [1, 1]]
    result = convex_hull_bf(points)
...
def test_convex_hull_bf_floating_point_coordinates():
...
def test_convex_hull_bf_invalid_input_wrong_dimension():
    points = [[1, 2, 3], [4, 5, 6]]
    with pytest.raises((ValueError, IndexError)):
        convex_hull_bf(points)


def test_convex_hull_bf_invalid_input_non_numeric():
    points = [["a", "b"], ["c", "d"]]

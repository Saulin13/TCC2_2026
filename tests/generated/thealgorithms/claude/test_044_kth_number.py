...
def test_kth_number_two_elements_first():
    assert kth_number([10, 5], 1) == 5


def test_kth_number_two_elements_second():
    assert kth_number([10, 5], 2) == 10


def test_kth_number_duplicates():
    assert kth_number([5, 2, 8, 2, 9, 1], 3) == 5


def test_kth_number_all_same():
    assert kth_number([7, 7, 7, 7], 2) == 7


def test_kth_number_negative_numbers():
    assert kth_number([-5, -1, -10, -3, -7], 2) == -7


def test_kth_number_mixed_positive_negative():
    assert kth_number([-3, 5, -1, 0, 2], 3) == 0
...
def test_kth_number_with_duplicates_at_k():
    assert kth_number([1, 3, 3, 3, 5], 3) == 3

...
def test_binary_exponentiation_negative_base():
    assert binary_exponentiation(-2, 3, 5) == 2
    assert binary_exponentiation(-5, 2, 13) == 12


def test_binary_exponentiation_float_exponent_even():
    assert binary_exponentiation(2, 4.0, 7) == 2
